              ...
              >
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td style="width: 35%;">
                        <div class="product-title">{{ $cart->product->user->store_name }}</div>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center">Carts not found</td>
                        </tr>
                    @endforelse
                </tbody>
              </table>
            ...
            <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select name="province_id" id="province_id" v-if="provinces" v-model="provinces_id" class="form-control">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select name="regency_id" id="regency_id" v-if="regencies" v-model="regencies_id" class="form-control">
