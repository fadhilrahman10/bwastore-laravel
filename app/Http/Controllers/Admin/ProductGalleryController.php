...
class ProductGalleryController extends Controller
{
    ...
    public function store(ProductGalleryRequest $request)
    {
        ...
        return redirect()->route('gallery.index')->with('success', 'New product Gallery has been added!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('gallery.index')->with('success', 'Product Gallery has been deleted!');
    }
}
